...
-- HeartBeat function
function HeartBeat()
    local url = "https://localhost:"..apiPort.."/intercom/monitor"
    local exData = {
...
function txaReportResources(source, args)
    ...
    --Send to txAdmin
    local url = "https://localhost:"..apiPort.."/intercom/resources"
    local exData = {
        txAdminToken = apiToken,
        resources = resources
    }
...
function handleConnections(name, skr, d)
    ...
    if isEnabled == "true" then
        d.defer()
        local url = "https://localhost:"..apiPort.."/intercom/checkWhitelist"
        local exData = {
            txAdminToken = apiToken,
