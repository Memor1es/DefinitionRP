                ...
                if mythic_action.animation ~= nil then
                    ...
                    elseif mythic_action.animation.animDict ~= nil and mythic_action.animation.anim ~= nil then
                        ...
                        if ( DoesEntityExist( player ) and not IsEntityDead( player )) then
                            ...
                            if mythic_action.animation.time ~= nil and mythic_action.animation.time ~= -1 then
                                Citizen.CreateThread(function()
                                    Citizen.Wait(tonumber(mythic_action.animation.time))
                                    StopAnimTask(player, mythic_action.animation.animDict, mythic_action.animation.anim, 1.0)
                                end)
                            end
                        end
                    else
