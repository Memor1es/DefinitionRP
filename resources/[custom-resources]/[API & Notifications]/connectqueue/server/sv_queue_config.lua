...
Config.donorLevels = {
    ...
    [3] = {Role = "Gold2", Priority = 30},
    [4] = {Role = "Silver2", Priority = 20},
    [5] = {Role = "Bronze2", Priority = 10},
    -- Remove after 4th August---------------
    [6] = {Role = "Hero", Priority = 35},
    [7] = {Role = "God", Priority = 30},
    [8] = {Role = "VIP", Priority = 25},
    [9] = {Role = "Platinum", Priority = 20},
    [10] = {Role = "Silver", Priority = 15},
    [11] = {Role = "Bronze", Priority = 10},
    -----------------------------------------
    [12] = {Role = "Nitro", Priority = 5},
    [13] = {Role = "Streamer", Priority = 4}
}
...
-- Config.JoinDelay = 3000000000000 -- Change Back Later
