...
SaveInGarage = function(garage)
    ...
    deleteCar(vehicle)
    local vehName = GetLabelText(GetDisplayNameFromVehicleModel(vehicleProps["model"]))
    TriggerServerEvent('betrayed_garage:modifystate', vehicleProps, 1, garage,vehName)
    CloseMenu()
end
...
DrawScriptMarker = function(markerData)
    ...
    DrawMarker(20, markerData["pos"],0,0,0,0,0,0,0.701,1.0001,0.3001,222, 50, 50, 0.05,0,1,0,0,0,0,0)
end
