...
rootMenuConfig =  {
    {
        ...
        subMenus = {"general:flipvehicle",  "general:checkoverself",  "general:checktargetstates",  "general:keysgive",  "general:emotes",  "general:checkvehicle",  --[[ "general:apartgivekey",  "general:aparttakekey", ]] "general:putinvehicle", "general:unseatnearest", "general:escort"}
    },
    {
        id = "police-action",
        ...
        subMenus = {"cuffs:cuff", "cuffs:softcuff", "cuffs:uncuff", "police:escort", "police:putinvehicle", "police:unseatnearest", "cuffs:checkinventory", "cuffs:friskinventory", --[[ "cuffs:remmask", ]]  --[[ "police:frisk", ]]--[[ "police:removeweapons" ]] "police:revive", "police:gsr", "police:openmdt", "police:getid", "police:impound", "police:spikes", "1013B"}
    },
    {
        id = "police-vehicle",
    ...
    },
    {
        ...
        displayName = "10-14B",
        icon = "#ems-dead",
        functionName = "tp:panicTriggerMedic2",
        enableMenu = function()
        local ped = PlayerPedId()
           PlayerData = ESX.GetPlayerData()
           fuck = exports["ambulancejob"]:GetDeath()
    ...
    }, ]]
    {
        ...
        enableMenu = function()
            ...
            PlayerData = ESX.GetPlayerData()
            fuck = exports["ambulancejob"]:GetDeath()
            if (PlayerData.job.name == "racersedge" or PlayerData.job.name == "flywheels" or PlayerData.job.name == "hellscustoms") and not fuck then
                return true
            end
        end,
        subMenus = { "mechanic:hijack", "mechanic:repair", "mechanic:impound", "mechanic:clean"}
    },
    {
        id = "medic",
        displayName = "Medical",
        ...
        subMenus = {"medic:revive", --[["medic:heal",]] "medic:bigheal", "medic:drag", "medic:undrag", "medic:putinvehicle", "medic:takeoutvehicle", "1014B" }
    },
    {
        id = "doctor",
        displayName = "Doctor",
        ...
        subMenus = { "general:escort", "medic:revive", "general:checktargetstates", "medic:heal", "1014B" }
    },
    {
        id = "news",
        displayName = "News",
...
--[[     ['general:checkvehicle'] = {
    ...
    ['general:putinvehicle'] = {
        ...
        functionName = "tp:genputinvehicle"
    },
    ['general:unseatnearest'] = {
        title = "Unseat Nearest",
        icon = "#general-unseat-nearest",
        functionName = "tp:gentakeoutvehicle"
    },    
    ['general:flipvehicle'] = {
        title = "Flip Vehicle",
...
--[[     ['judge-raid:checkowner'] = {
    ...
    ['cuffs:friskinventory'] = {
        title = "Frisk Person",
        icon = "#cuffs-check-inventory",
        functionName = "disc-inventoryhud:frisk"
    },
    ['cuffs:unseat'] = {
        title = "Unseat",
