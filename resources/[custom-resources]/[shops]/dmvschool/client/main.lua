...
Citizen.CreateThread(function()
    ...
    npcpos = {x =239.91024780273, y =-1380.3559570313, z =33.741760253906}
    
    local bool, groundZ = GetGroundZFor_3dCoord(npcpos.x, npcpos.y, npcpos.z)
    
    local npc = CreatePed(4, 0xA1435105, npcpos.x, npcpos.y, groundZ, 0.0, false, true)
    
    SetEntityHeading(npc, 140.0)
