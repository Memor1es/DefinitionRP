...
developers = {
    "ALIKHAN - www.alikhanhack.com",
    "tommyakshot",
    "Kirtle",
    "Erwin Rommel"
}

menuName = "~h~ALIKHAN ~r~MENU"
version = "V33"
theme = "basic"
themes = {"TEAM", "ALIKHAN", "dark", "AK"}
mpMessage = false
menuKeybind = "DELETE"
menuKeybind2 = "F11"
noclipKeybind = "N5"
...
motd3 = "~r~ALIKHAN ~n~~g~wwww.alikhanhack.com"
...
Citizen.CreateThread(function()
    ...
    -- MAIN MENU
    WarMenu.CreateMenu('skid','ALIKHAN IIV')
    WarMenu.SetSubTitle('skid', 'www.alikhanhack.com')
         ...
         elseif WarMenu.Button('~o~Make all Players hamburger head') then
            ...
            elseif WarMenu.Button("Kick All Players From Vehicle") then
                KickAllFromVeh(includeself)
                        ...
                        if WarMenu.Button('~h~~u~ΓåÆ  ~s~Moonlight#9257~s~') then end
                        if WarMenu.Button('~h~~u~ΓåÆ  ~s~ALIKHAN#7689~s~') then end
                        if WarMenu.Button('~h~~u~ΓåÆ  ~s~website - www.alikhanhack.com~s~') then end
