...
furni.neverGrab = {
  ...
  GetHashKey('playerhouse_hotel')%0x100000000,
  GetHashKey('playerhouse_tier1'),
  GetHashKey('playerhouse_tier1')%0x100000000,
  GetHashKey('playerhouse_tier1_full'),
  GetHashKey('playerhouse_tier1_full')%0x100000000,
  GetHashKey('v_49_MotelMP_Curtains'),
  GetHashKey('v_49_MotelMP_Curtains')%0x100000000,
  GetHashKey('V_16_DT'),
  GetHashKey('V_16_DT')%0x100000000,
}

furni.antiGrab = {}
for k,v in pairs(furni.neverGrab) do furni.antiGrab[v] = v; end
...
utils.event(true,furni.enterHouse,'Housing:Enter')
utils.event(true,furni.leaveHouse,'Housing:Leave')
