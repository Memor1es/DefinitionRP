...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(arms) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Press ~INPUT_CONTEXT~ to train your ~g~arms = Stamina')
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(chins) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Press ~INPUT_CONTEXT~ to do some ~g~pull-ups = Strength')
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(pushup) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Press ~INPUT_CONTEXT~ to do some ~g~pushups = Strength')
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(yoga) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Press ~INPUT_CONTEXT~ to do some ~g~yoga = Lung Capacity')
				...
				if IsControlJustPressed(0, Keys['E']) then
					if training == false then
						...
						if membership == true then	
							...
							Citizen.Wait(30000)
							ClearPedTasksImmediately(playerPed)
							exports["gamz-skillsystem"]:UpdateSkill("Lung Capacity", 2)
							ESX.ShowNotification("You need to rest ~r~60 seconds ~w~before doing another exercise.")
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(situps) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Press ~INPUT_CONTEXT~ to do some ~g~situps = Stamina')
