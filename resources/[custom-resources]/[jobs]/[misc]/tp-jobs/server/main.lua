...
Config.Rocks = { 
    ...
    {x = 2934.56, y = 2784.27, z = 40.19, health = 10, data = "copper", max = 10}
...
--[[ Citizen.CreateThread(function()
    while true do
        Citizen.Wait(10000)
        PrintTableOrString(Config.Rocks)
    end
end) ]]
...
X.StartReloads = function()
	Citizen.CreateThread(function()
		while true do
			Citizen.Wait(1800000) -- treereload (Now 10 mins instead of 60 seconds)
