...
ESX.RegisterUsableItem('pomarancza', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You ate an orange'})
...
ESX.RegisterUsableItem('jablka', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'hunger', 80000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You ate an apple'})
...
ESX.RegisterUsableItem('sok', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You drank some juice'})
