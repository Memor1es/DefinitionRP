...
AddEventHandler('WellDoPizza:Zaplata', function()
    ...
    xPlayer.addMoney(55)
   TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'error', text = 'You got $55 for pizza delivery.'})
...
AddEventHandler('WellDoPizza:OddajKaucje', function(info)
    ...
    if info == 'zakonczenie' then
        ...
        TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'success', text = 'You got $100 extra for deliveries and the deposit has been returned to you.'})
      --  TriggerClientEvent('pNotify:SendNotification', source, {text = 'You got $350 extra for deliveries and the deposit has been returned to you.'})
        ...
        TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'success', text = 'The deposit has been returned to you.'})
