Config = {
    ...
    Jobs = {
        ...
        {title = 'Drive a load of furniture to YouTool', payment = 900, vehicles = {'phantom', 'trailers'}, start = {vector3(954.77, -2188.86, 29.63), 84.99}, trailer = {vector3(939.0, -1799.2, 30.1), 175.78}, arrive = vector3(2671.0, 3530.35, 51.26)},
        {title = 'Drive a load of meat to the supermarket', payment = 350, vehicles = {'packer', 'trailers2'}, start = {vector3(868.77, -2341.7, 29.44), 174.68}, trailer = {vector3(946.29, -2111.86, 29.64), 86.76}, arrive = vector3(103.57, -1819.37, 25.56)},
        ...
        {title = 'Drive a tanker of fuel to a fuel station', payment = 700, vehicles = {'hauler', 'tanker'}, start = {vector3(954.77, -2188.86, 29.63), 84.99}, trailer = {vector3(1699.52, -1500.15, 113.226), 69.63}, arrive = vector3(-2101.86, -293.84, 13.261)},
        {title = 'Drive a load of wood to Lumber Yard', payment = 1200, vehicles = {'hauler', 'trailerlogs'}, start = {vector3(954.77, -2188.86, 29.63), 84.99}, trailer = {vector3(939.0, -1799.2, 30.1), 175.78}, arrive = vector3(-578.2, 5252.5, 70.5)},
}}
