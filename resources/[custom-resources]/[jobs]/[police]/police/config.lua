...
Config.AuthorizedVehicles = {
	Shared = {
		--
		{ model = 'vic11', label = 'Crown Victoris 2011', price = 0 },
	...
	patrolofficer = {
		...
		{ model = 'policeb2', label = 'Police Dirt Bike', price = 0 },
		{ model = 'taurus', label = 'Taurus', price = 0 },
		{ model = 'charger', label = 'Dodge Charger 2018', price = 0 },
		{ model = 'charger14', label = 'Dodge Charger 2014', price = 0 },
		{ model = 'explorer', label = 'Ford Explorer 2016', price = 0 },
		{ model = '2015polstang', label = 'Ford Mustang GT500', price = 0 },
		{ model = 'ram2500', label = 'Dodge Ram 2500', price = 0 },
		{ model = 'tahoe', label = '2020 Tahoe', price = 0 },
		{ model = 'tahoe13', label = 'DoC Tahoe', price = 0 },
		{ model = 'camaro', label = 'Camaro', price = 0 },
		...
		{ model = 'FIBjackal', label = 'UC Jackal', price = 0 },
		{ model = 'asea3', label = 'Asea UC', price = 0 },
		{ model = 'dvdt3', label = 'UC Dominator GTX', price = 0 },
		{ model = 'nspeedo', label = 'Police Vapid Van', price = 0 },
		{ model = 'tailgater2', label = 'UC Tailgater', price = 0 },
		{ model = 'sspres', label = 'SWAT suburban', price = 0 },
		{ model = 'fibn', label = 'UC Neon', price = 0 },
	},
