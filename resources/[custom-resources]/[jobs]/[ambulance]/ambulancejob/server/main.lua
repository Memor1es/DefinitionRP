...
AddEventHandler('esx_ambulancejob:heal', function(target, type)
	...
	if xPlayer.job.name == 'ambulance' and type == 'small' then
		...
		TriggerClientEvent("heal",target)
	elseif
...
RegisterServerEvent('esx_general:putInVehicle')
AddEventHandler('esx_general:putInVehicle', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('esx_general:putInVehicle', target)
end)

RegisterServerEvent('esx_general:pullOutVehicle')
AddEventHandler('esx_general:pullOutVehicle', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('esx_general:pullOutVehicle', target)
end)
...
RegisterServerEvent('esx_general:drag')
AddEventHandler('esx_general:drag', function(target)
	TriggerClientEvent('tp_generaldrag', target, source)
end)

RegisterServerEvent('esx_general:undrag')
AddEventHandler('esx_general:undrag', function(target)
	print(target)
	TriggerClientEvent('tp_generalundrag', target)
end)
...
TriggerEvent('es:addGroupCommand', 'revive', 'admin', function(source, args, user)
	if args[1] ~= nil then
		if args[1] == "all" then
			print(('esx_ambulancejob: %s used admin revive ALL PLAYERS'):format(GetPlayerIdentifiers(source)[1]))
