...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Vehicles = {
			{
				Spawner = vector3(294.9, -601.5, 42.4),
				InsideShop = vector3(446.7, -1355.6, 43.5),
				Marker = { type = 27, x = 1.2, y = 1.2, z = 1.2, r = 225, g = 0, b = 0, a = 200, rotate = true },
				SpawnPoints = {
...
Config.AuthorizedVehicles = {
	...
	doctor = {
		{ model = 'ambulance', label = 'Ambulance Van', price = 5},
		{ model = 'newhoe3', label = 'Tahoe', price = 5},
		{ model = 'everest2', label = 'RRV', price = 5}
	},
	...
	boss = {
		{ model = 'ambulance', label = 'Ambulance Van', price = 5},
		{ model = 'newhoe3', label = 'Tahoe', price = 5},
		{ model = 'batallionf350', label = 'F350', price = 5},
		{ model = 'everest2', label = 'RRV', price = 5}
	}
