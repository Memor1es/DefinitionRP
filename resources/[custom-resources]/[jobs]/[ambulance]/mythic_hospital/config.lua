...
Config.Weapons = {
    ...
    [`WEAPON_KITCHENKNIFE`] = Config.WeaponClasses['CUTTING'],
    ...
    [`WEAPON_BBAT`] = Config.WeaponClasses['HEAVY_IMPACT'],
    [`WEAPON_MALLET`] = Config.WeaponClasses['HEAVY_IMPACT'],
    [`WEAPON_SHOVEL`] = Config.WeaponClasses['HEAVY_IMPACT'],
