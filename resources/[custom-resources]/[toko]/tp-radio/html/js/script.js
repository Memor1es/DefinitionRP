...
$(function() {
    ...
    document.onkeyup = function(data) {
        if (data.which == 27) { // Escape key
            $.post('https://tp-radio/escape', JSON.stringify({}));
        }
    };
    ...
    $("#login-form").submit(function(e) {
        ...
        $.post('https://tp-radio/joinRadio', JSON.stringify({
            channel: $("#channel").val()
        }));
    });
    ...
    $("#onoff").click(function(e) {
        ...
        $.post('https://tp-radio/leaveRadio', JSON.stringify({

        }));
    });

    $("#volumeUp").click(function() {
        $.post('https://tp-radio/click', JSON.stringify({}));
        $.post('https://tp-radio/volumeUp', JSON.stringify({}));
    });

    $("#volumeDown").click(function() {
        $.post('https://tp-radio/click', JSON.stringify({}));
        $.post('https://tp-radio/volumeDown', JSON.stringify({}));
    });
