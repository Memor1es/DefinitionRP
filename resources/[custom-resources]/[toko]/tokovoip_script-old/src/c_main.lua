...
AddEventHandler("initializeVoip", function()
    ...
    --[[ ESX.TriggerServerCallback('tokovoip:getPass', function(password)
        -- print(password) --would never get called
        TokoVoipConfig.plugin_data.TSPassword = password
    end) ]]
