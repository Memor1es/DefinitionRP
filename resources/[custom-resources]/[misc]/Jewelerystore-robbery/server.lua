...
ESX.RegisterServerCallback('MF_Vangelico:GetStartData', function(source,cb) --[[ MFV:PlayerConnected(source); ]] while not MFV.dS do Citizen.Wait(0); end; cb(MFV.cS); end)
