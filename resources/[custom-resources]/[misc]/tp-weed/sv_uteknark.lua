...
RegisterServerEvent('drp:weed:breaklighter')
AddEventHandler('drp:weed:breaklighter', function()
    local xPlayer = ESX.GetPlayerFromId(source)
    while not xPlayer do Citizen.Wait(0); ESX.GetPlayerFromId(source); end
...
RegisterServerEvent('useableitem:remove')
AddEventHandler('useableitem:remove', function(item)
    local xPlayer = ESX.GetPlayerFromId(source)
    local src = source
