...
Config.Color         = { r = 100, g = 100, b = 100 }
Config.Type          = 1
...
Config.Rifle_stock		= math.random(1,3)
...
Config.Cat_pistols	= 1
Config.Cat_rifles	= 1
Config.Cat_snipers	= 0
Config.Cat_shotgun	= 0
Config.Cat_smg		= 0
...
Config.Weapon_restock = {
	...
	pistol	= {
...

		{
			...
			price			= 1500,
			starting_stock	= math.random(6,7)
		}
	},
	...
	rifle	= {
		{
			...
			price			= 75000,
			starting_stock	= math.random(1,3)
		}
...
Config.Zones = {
	...
	BlackMarket = {
		...
		Items = {},
		Locations = {
			-- vector3(-126.56474304199, -2530.6918945312, 5.10)
			vector3(720.750, 1291.390, 359.296)
		}
	}
}