...
exports('PDEMSRepair', PDEMSRepairVehicle)

function PDEMSRepairVehicle()
	...
	if Config.EnablePrice then
		exports['mythic_notify']:SendAlert('success', 'You have repaired your vehicle')
	else
		exports['mythic_notify']:SendAlert('error', 'Your repair was unsuccessful')
	end
end
...
function RepairVehicle()
	ESX.TriggerServerCallback('esx_repair:canAfford', function(canAfford)
		if canAfford then
			...
			if Config.EnablePrice then
				exports['mythic_notify']:SendAlert('success', 'You have repaired your vehicle costing $'..ESX.Math.GroupDigits(Config.Price)))
			else
				exports['mythic_notify']:SendAlert('error', 'Your repair was unsuccessful')
			end
			Citizen.Wait(5000)
