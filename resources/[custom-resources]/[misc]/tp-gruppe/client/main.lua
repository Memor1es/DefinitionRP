       ...
       -- Citizen.Trace("Doing Animation")
        ...
        while pickingup do
            ...
            if math.random(200) > 195 and gotem == false then
                ...
                TriggerServerEvent('tp_gruppe:gimmethadirtycash', math.random(4000,5000))
            end

            if chance < 10 then
                AlertPD()
                TriggerServerEvent('tp_gruppe:gimmethadirtycashh', math.random(1000,1250))
            end

            TriggerServerEvent('tp_gruppe:gimmethadirtycash', math.random(1000,1250))
