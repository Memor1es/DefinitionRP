...
RegisterNetEvent('DRP:Inventory:ClientGiveAnimation')
AddEventHandler('DRP:Inventory:ClientGiveAnimation', function()
    loadAnimDict( "mp_safehouselost@" )
    TaskPlayAnim( PlayerPedId(), "mp_safehouselost@", "package_dropoff", 8.0, 1.0, 2000, 16, 0, 0, 0, 0 )
    ...
    --        TaskPlayAnim(playerPed, 'random@domestic', 'pickup_low', 8.0, -8, 2000, 48, 0, 0, 0, 0)
    --    end)
    --end
end)
