...
RegisterNUICallback('InvLog', function(data, cb)
    TriggerServerEvent('discordbot:invlog', data.message)
    cb('OK')
end)

RegisterNUICallback('craft', function(data, cb)
    TriggerServerEvent('disc-inventoryhud:craft', data)
    cb('OK')
end)
...
function hasEnoughOfItem(item, count)
