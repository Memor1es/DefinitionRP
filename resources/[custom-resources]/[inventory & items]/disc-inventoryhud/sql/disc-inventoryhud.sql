...
INSERT INTO essentialmode.items (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('WEAPON_BBAT', 'Knife', 1, 0, 1);
INSERT INTO essentialmode.items (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('WEAPON_KITCHENKNIFE', 'Knife', 1, 0, 1);
INSERT INTO essentialmode.items (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('WEAPON_MALLET', 'Knife', 1, 0, 1);
INSERT INTO essentialmode.items (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('WEAPON_SHOVEL', 'Knife', 1, 0, 1);
